...
function Slider (images) {
	...
	Slider.prototype.createHtml.call(this, images);
	Slider.prototype.carousel.call(this, 1000, 5000);

	return this.html;
}

Slider.prototype.createHtml = function(images) {
	...
	Slider.prototype.updateimgs.call(this);
};

Slider.prototype.updateimgs = function() {
	for (var i = -1; i < 2; i++) {
...
Slider.prototype.carousel = function (speed, timeout) {
	...
	return setInterval(function() {
		...
		animate({
			...
			self.updateimgs();
			self.html.firstChild.style.left = '0px';
		});
	}, timeout);
}